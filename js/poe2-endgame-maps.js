...
const TableRenderer = {
    buildTable() {
        ...
        // 動的生成を廃止し、あらかじめHTML側に存在するDOM.noResultRowを含めて再配置
    ...
    createResistIcon(foundKey) {
        if (foundKey && getIconPath(foundKey)) {
            ...
            img.onerror = function () {
                this.onerror = null; // メモリリーク防止＆無限ループ防止
